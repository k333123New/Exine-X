...
namespace ServerPacket
{
    public sealed class KeepAlive : Packet
    {
        ...
        protected override void ToParse(BinaryReader reader)
        {
            Time = reader.ReadInt64();
        }

        protected override void MakePacket(BinaryWriter writer)
        {
            writer.Write(Time);
        }
    }
    ...
    public class UserInformation : Packet
    {
        ...
        protected override void ToParse(BinaryReader reader)
        {
            ...
            Console.WriteLine("ExStyle #7 :" + ExStyle);
        ...
        protected override void MakePacket(BinaryWriter writer)
        {
            ...
            Console.WriteLine("ExStyle #8 :" + ExStyle);
            Console.WriteLine("ExPortraitLen.Len #8 :" + ExPortraitLen);
    ...
    public class ObjectPlayer : Packet
    {
        ...
        protected override void ToParse(BinaryReader reader)
        {
            ...
            ExPortraitLen = (int)reader.ReadInt32();//add k333123
            ExPortraitBytes = reader.ReadBytes(8000);//add k333123
            Console.WriteLine("ExStyle A :" + ExStyle);
    ...
    public sealed class ObjectRest : Packet //add 231107
    {
        public override short Index
        {
            get { return (short)ServerPacketIds.ObjectRest; }
        }
