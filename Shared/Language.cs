public class GameLanguage
{
    ...
    public static string PetMode_Both = "[펫: 공격 및 이동]",
                         ...
                         YouGained2 = "{0:###,###,###} {1}을(를) 얻었습니다.",

                         ExperienceGained = "획득 경험치 {0}",

                         HeroInventory = "영웅 인벤토리 ({0})",
                         HeroCharacter = "영웅 캐릭터 ({0})",
                         HeroSkills = "영웅 스킬 ({0})",
                         HeroExperienceGained = "영웅 경험치 획득 {0}",

                         ItemDescription = "아이템 설명",
                         RequiredLevel = "필요 레벨 : {0}",
                         RequiredDC = "필요 DC : {0}",
                         RequiredMC = "필요 MC : {0}",
                         RequiredSC = "필요 SC : {0}",
                         ClassRequired = "필요한 직업 : {0}",
                         ...
                         Count = "개수 {0}",
                         ExtraSlots8 = "1,000,000데니에 추가 슬롯 8개를 구매하시겠습니까?" +
                         "다음 구매 시 최대 40개까지 추가 슬롯을 잠금 해제할 수 있습니다.",
                         ExtraSlots4 = "데니로 4개의 추가 슬롯을 잠금 해제하시겠습니까? {0:###,###}",
                         ...
                         Chat_Group = "그룹",
                         Chat_Guild = "길드",
                         ExpandedStorageLocked = "확장된 스토리지 잠김",
                         ExtraStorage = "1,000,000데니의 비용으로 10일 동안 추가 보관 공간을 임대하시겠습니까?",
                         ExtendYourRentalPeriod = "1,000,000 골드의 비용으로 대여 기간을 10일 연장하시겠습니까?",

                         CannotLeaveGame = "{0}초 동안 게임을 떠날 수 없습니다.",
                         SelectKey = "{0}에 대한 키를 선택하세요.",

                         WeaponSpiritFire = "당신의 무기는 불의 정령으로 빛납니다.",
                         SpiritsFireDisappeared = "불의 정령이 사라졌습니다.",
                         WeddingRing = "결혼 반지",
                         ItemTextFormat = "{0}{1}{2} {3}",
                         DropAmount = "드롭 수량:",
                         LowMana = "마나가 부족합니다.",
                         NoCreatures = "당신은 어떤 생물도 소유하고 있지 않습니다.",
                         NoMount = "당신은 탈것을 소유하지 않았습니다.",
                         NoFishingRod = "당신은 낚싯대를 들고 있지 않습니다.",
                         AttemptingConnect = "서버에 연결을 시도 중입니다.{0}시도:{1}",

                         CreatingCharactersDisabled = "현재 새 캐릭터 생성이 비활성화되어 있습니다.",
                         InvalidCharacterName = "캐릭터 이름이 허용되지 않습니다.",
                         NoClass = "선택한 클래스가 없습니다. GM에 문의하여 도움을 요청하세요.",
                         ToManyCharacters = "{0}개 캐릭터 이후에는 더 이상 만들 수 없습니다.",
                         CharacterNameExists = "이 이름을 가진 캐릭터가 이미 존재합니다.",
                         WarriorsDes = "전사는 엄청난 힘과 활력을 가진 직업입니다. 그들은 전투에서 쉽게 죽지 않으며 다양한 중화기와 갑옷을 사용할 수 있다는 장점이 있습니다. 따라서 전사는 근접 물리 피해를 기반으로 하는 공격을 선호합니다. 그들은 원거리 공격에 약하지만 전사를 위해 특별히 개발된 다양한 장비는 원거리 전투에서의 약점을 보완합니다.",
                         WizardDes = "마법사는 힘과 체력이 낮은 직업이지만 강력한 주문을 사용할 수 있는 능력을 가지고 있습니다. 그들의 공격 주문은 매우 효과적이지만, 이러한 주문을 시전하는 데 시간이 걸리기 때문에 적의 공격에 노출될 가능성이 높습니다. 따라서 신체적으로 약한 마법사는 안전한 거리에서 적을 공격해야 합니다.",
                         TaoistDes = "도사는 무공을 제외한 천문학, 의학 및 기타 학문을 잘 훈련합니다. 적과 직접 싸우는 대신, 그들의 전문성은 아군을 지원하는 데 있습니다. 도교는 강력한 생물을 소환할 수 있고 마법에 대한 저항력이 높으며, 공격 및 방어 능력이 균형 잡힌 직업입니다.",
                         AssassinDes = "암살자는 비밀 조직의 일원이며 그들의 역사는 비교적 알려지지 않았습니다. 그들은 자신을 숨기고 다른 사람들에게 보이지 않게 공격을 수행할 수 있으며, 이는 자연스럽게 빠른 살인을 하는 데 탁월합니다. 그들은 약한 생명력과 힘으로 인해 여러 적과 전투를 피하는 것이 필요합니다.",
                         ArcherDes = "궁수는 뛰어난 정확도와 힘을 가진 계열로, 활을 이용한 강력한 기술을 사용하여 원거리에서 엄청난 피해를 입힙니다. 마법사와 마찬가지로, 그들은 정면 공격에 취약한 경향이 있기 때문에 다가오는 공격을 피하기 위해 예리한 본능에 의존합니다. 그러나 그들의 신체적 능력과 치명적인 조준은 그들이 맞은 모든 사람에게 두려움을 심어줄 수 있습니다.",
                         DateSent = "보낸 날짜 : {0}",
                         Send = "보내기",
                         Reply = "회신",
                         Read = "읽기",
                         Delete = "삭제",
                         BlockList = "차단 목록",
                         EnterMailToName = "메일을 보내고 싶은 사람의 이름을 입력하세요.",
                         AddFriend = "추가",
                         RemoveFriend = "제거",
                         FriendMemo = "메모",
                         FriendMail = "메일",
                         FriendWhisper = "귓속말",
                         FriendEnterAddName = "추가하고 싶은 사람의 이름을 입력하세요.",
                         FriendEnterBlockName = "차단하려는 사람의 이름을 입력하세요.",
                         AddMentor = "멘토 추가",
                         RemoveMentorMentee = "멘토/멘티 제거",
                         MentorRequests = "멘토 요청 허용/불허",
                         MentorEnterName = "멘토가 되고자 하는 사람의 이름을 입력하세요.",
                         RestedBuff = "Rested{0}Increases Exp Rate by {1}%{2}",

                         ItemTypeWeapon = "무기",
                         ItemTypeArmour = "갑옷",
                         ItemTypeHelmet = "헬멧",
                         ItemTypeNecklace = "목걸이",
                         ItemTypeBracelet = "팔찌",
                         ItemTypeRing = "반지",
                         ItemTypeAmulet = "부적",
                         ItemTypeBelt = "벨트",
                         ...
                         ItemTypeFish = "물고기",
                         ItemTypeQuest = "퀘스트",
                         ItemTypeAwakening = "각성",
                         ItemTypePets = "애완동물",
                         ItemTypeTransform = "변환",
                         ItemTypeDeco = "데코",
                         ItemTypeMonsterSpawn = "스폰에그",
                         ItemTypeSealedHero = "봉인된 영웅",

                         ItemGradeCommon = "일반",
                         ItemGradeRare = "레어",
                         ItemGradeLegendary = "전설",
                         ItemGradeMythical = "신화",
                         ItemGradeHeroic = "영웅",
                         NoAccountID = "AccountID가 존재하지 않습니다.",
                         IncorrectPasswordAccountID = "비밀번호와 계정 ID 조합이 잘못되었습니다.",
                         GroupSwitch = "그룹 요청 허용/불허",
                         GroupAdd = "초대",
                         GroupRemove = "제외",
                         GroupAddEnterName = "추가하려는 사람의 이름을 입력하세요.",
                         GroupRemoveEnterName = "제외하려는 사람의 이름을 입력하세요.",
                         TooHeavyToHold = "너무 무거워서 잡을 수 없습니다.",
                         SwitchMarriage = "결혼 허용/차단",
                         RequestMarriage = "청혼 요청",
                         RequestDivorce = "이혼 요청",
                         MailLover = "연인에게 메일",
                         WhisperLover = "연인에게 귀속말";

    //Server
    public static string Welcome = "{0} Exine 서버에 오신 것을 환영합니다.",
                         OnlinePlayers = "온라인 플레이어: {0}",
                         WeaponLuck = "행운이 당신의 무기 속에 깃들어 있습니다.",
                         WeaponCurse = "저주가 당신의 무기 속에 깃들어 있습니다.",
                         WeaponNoEffect = "효과 없음.",
                         InventoryIncreased = "인벤토리 크기가 증가했습니다.",
                         FaceToTrade = "거래하려면 누군가와 마주해야 합니다.",
                         NoTownTeleport = "여기에서는 타운 텔레포트를 사용할 수 없습니다",
                         CanNotRandom = "여기에서는 무작위 텔레포트를 사용할 수 없습니다",
                         ...
                         BlockingMentorRequests = "이제 멘토 요청을 차단했습니다.";

    //common
    public static string LowLevel = "당신은 충분히 높은 레벨이 아닙니다.",
                         LowGold = "돈이 부족합니다.",
                         LevelUp = "축하합니다! 레벨이 높아졌습니다. HP와 MP가 복원되었습니다.",
                         LowDC = "DC가 충분하지 않습니다.",
                         LowMC = "MC가 충분하지 않습니다.",
                         LowSC = "SC가 충분하지 않습니다.",
                         GameName = "Exine",
                         ExpandedStorageExpiresOn = "확장된 저장소 만료일",

                         NotFemale = "당신은 여성이 아닙니다.",
                         NotMale = "당신은 남성이 아닙니다.",
                         NotInGuild = "길드에 가입되어 있지 않습니다.",
                         NoMentorship = "현재 취소할 멘토링이 없습니다.",
                         NoBagSpace = "공간이 충분하지 않습니다.";
