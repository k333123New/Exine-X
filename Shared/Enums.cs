...
public enum Monster : ushort
{
    ...
    ExSeiren = 20028,
    ExJrachok = 20029,
    ExCerberusRich = 20030,
    ExCerberusRich111 = 20031,
    ExCerberusRich222 = 20032,
    ExCerberusRich333 = 20033,
    ExCerberusRich444 = 20034,
    ExCerberusRich555 = 20035,
    ExCerberusRich666 = 20036,
    ...
    ExPyrus = 20068,
    ExWall = 20069,
    ExDragonsHeartLeft = 20070,
    ExDragonsHeartCenter = 20071,
    ExDragonsHeartRight = 20072,
...
public enum ExAction : byte
{
    ...
    PEACEMODE_WALK_LEFT, //305,4,0,100, 112,6,0,100
    ONEHAND_WALK_LEFT,   //337,4,0,100, 112,6,0,100
    TWOHAND_WALK_LEFT,   //369,4,0,100, 112,6,0,100
    BOWHAND_WALK_LEFT,   //401,4,0,100, 112,6,0,100
    PEACEMODE_RUN_LEFT, //305,4,0,100, 112,6,0,100
    ONEHAND_RUN_LEFT,   //337,4,0,100, 112,6,0,100
    ...
    ONEHAND_ATTACK2,    //625,8,0,100, 216,6,0,100
    ONEHAND_ATTACK3,    //689,8,0,100, 448,6,0,100
    TWOHAND_ATTACK1,    //753,8,0,100, 168,6,0,100
    TWOHAND_ATTACK2,    //817,8,0,100, 216,6,0,100
    TWOHAND_ATTACK3,    //881,8,0,100, 448,6,0,100
    BOWHAND_ATTACK1,    //945,8,0,100, 96,8,0,100
    MAGIC_CAST,         //1009,1,0,1000, 160,1,0,1000
    MAGIC_ATTACK,       //1017,1,0,1000, 332,1,5,1000
    PEACEMODE_WALK_RIGHT,//1025,4,0,100, 112,6,0,100
    ONEHAND_WALK_RIGHT,  //1057,4,0,100, 112,6,0,100
    TWOHAND_WALK_RIGHT,  //1089,4,0,100, 112,6,0,100
    BOWHAND_WALK_RIGHT,  //1121,4,0,100, 112,6,0,100
    PEACEMODE_RUN_RIGHT,//1025,4,0,100, 112,6,0,100
    ONEHAND_RUN_RIGHT,  //1057,4,0,100, 112,6,0,100
    TWOHAND_RUN_RIGHT,  //1089,4,0,100, 112,6,0,100
    BOWHAND_RUN_RIGHT,  //1121,4,0,100, 112,6,0,100
    PEACEMODE_STANDUP,  //1153,8,0,100
...
public enum ExineGender : byte
{
    Male = 0,
    Female = 1
}

public enum ExineClass : byte
{
    Warrior = 0,
    Wizard = 1,
    Taoist = 2,
