...
namespace ExineLibPositionSwapXY
{
    ...
    /// </summary>
    public sealed class MLibraryV2LocationMgr
    {
        ...
        public MLibraryV2LocationMgr(string filename)
        {
            FileName = filename;
            Initialize();
            Close();
        ...
        public void Initialize()
        {
            ...
            if (CurrentVersion >= 3)
            {
                ...
                {
                    Frames.Add((MirAction)_reader.ReadByte(), new M2Frame(_reader));
                }
            }
        }
        ...
        public void SaveSwapXY(string saveFileName)
        {
            Close();
            ...
            _stream = File.Create(saveFileName);
            writer = new BinaryWriter(_stream);
        ...
        public sealed class MImage
        {
            ...
            public void SaveSwapXY(BinaryWriter writer)
            {
                writer.Write(Width);
                writer.Write(Height);
                //writer.Write(X);
