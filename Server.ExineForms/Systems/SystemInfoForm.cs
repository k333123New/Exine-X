...
namespace Server
{
    public partial class SystemInfoForm : Form
    {
        ...
        private void UpdateFishing()
        {
            ...
            ExineDatabase.MonsterInfo fishingMob = Envir.GetMonsterInfo(Settings.FishingMonster);
        ...
        private void FishingMobIndexComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ExineDatabase.MonsterInfo mob = Envir.MonsterInfoList[FishingMobIndexComboBox.SelectedIndex];
