...
{
    public class ExineAnimatedControl : ExineImageControl
    {
        public static List<ExineAnimatedControl> Animations = new List<ExineAnimatedControl>();
