...
{
    public class ExineControl : IDisposable
    {
        public static ExineControl ActiveControl, MouseControl;
        ...
        #region Controls
        public List<ExineControl> Controls { get; private set; }
        public event EventHandler ControlAdded , ControlRemoved;
        private void AddControl(ExineControl control)
        {
            Controls.Add(control);
            OnControlAdded();
        }
        public void InsertControl(int index, ExineControl control)
        {
        ...
        private void RemoveControl(ExineControl control)
        {
        ...
        protected virtual void OnEnabledChanged()
        {
            ...
            if (Controls != null)
                foreach (ExineControl control in Controls)
        ...
        #region Parent
        private ExineControl _parent;
        public ExineControl Parent
        {
            get { return _parent; }
            set
            {
...
// ReSharper restore InconsistentNaming
        ...
        public ExineControl()
        {
            Controls = new List<ExineControl>();
            _opacity = 1F;
            _enabled = true;
