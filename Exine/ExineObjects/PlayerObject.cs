    ...
    public class PlayerObject : MapObject
    {
        ...
        public bool HasClassWeapon
        {
            get
            {
                ...
                {
                    default:
                        return Class == ExineClass.Wizard || Class == ExineClass.Warrior || Class == ExineClass.Taoist;
                    case 1:
                        return Class == ExineClass.Assassin;
                    case 2:
                        return Class == ExineClass.Archer;
                }
            }
        }
        ...
        public void Load(S.ObjectPlayer info)
        {
            ...
            if (Dead) ActionFeed.Add(new QueuedAction { Action = ExAction.Dead, Direction = Direction, Location = CurrentLocation });
        ...
        public void MountUpdate(S.MountUpdate info)
        {
            ...
            QueuedAction action = new QueuedAction { Action = ExAction.Standing, Direction = Direction, Location = CurrentLocation };
        ...
        public virtual void SetLibraries()
        {
            ...
            if (TransformType > -1)
            {
                ...
                switch (CurrentAction)
                {
                    ...
                    case ExAction.Jump:
                        Frames.TryGetValue(ExAction.Standing, out Frame);
                        break;
                    case ExAction.Walking:
                    case ExAction.WalkingBow:
                        Frames.TryGetValue(ExAction.Walking, out Frame);
                        break;
            ...
            else
            {
                ...
                switch (Class)
                {
                    ...
                    case ExineClass.Archer:
                        ...
                        if (CurrentAction == ExAction.Jump) altAnim = true;
                        ...
                        #region Offsets
                        ArmourOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 352 : 808;
                        HairOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 352 : 808;
                        WeaponOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 352 : 416;
                        WingOffset = Gender == ExineGender.Male ? 0 : altAnim ? 352 : 840;
                        MountOffset = 0;
                        #endregion
                    ...
                    case ExineClass.Assassin:
                        ...
                        #region Offsets
                        ArmourOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 512 : 808;
                        HairOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 512 : 808;
                        WeaponOffSet = Gender == ExineGender.Male ? 0 : altAnim ? 512 : 416;
                        WingOffset = Gender == ExineGender.Male ? 0 : altAnim ? 544 : 840;
                        MountOffset = 0;
                        #endregion
        ...
        public override void Process()
        {
            ...
            if (this == User)
            {
                if (CMain.Time - ExineMainScene.LastRunTime > 899)
            ...
            switch (CurrentAction)
            {
                ...
                case ExAction.DashAttack:
                    ...
                    if (CurrentAction == ExAction.DashAttack) i = JumpDistance;

                    Movement = Functions.PointMove(CurrentLocation, Direction, CurrentAction == ExAction.Pushed ? 0 : -i);

                    int count = Frame.Count;
                    int index = FrameIndex;

                    if (CurrentAction == ExAction.DashR || CurrentAction == ExAction.DashL)
                    {
                        count = 3;
                        index %= 3;
                    }
        ...
        public virtual void SetAction()
        {
            ...
            if (ActionFeed.Count == 0)
            {
                ...
                if (CurrentAction == ExAction.Standing)
                {
                    if (Class == ExineClass.Archer && HasClassWeapon)
                        CurrentAction = ExAction.Standing;
                    else
                        CurrentAction = CMain.Time > StanceTime ? ExAction.Standing : ExAction.Stance;
                }
            ...
            else
            {
                ...
                switch (CurrentAction)
                {
                    ...
                    case ExAction.DashFail:
                        Frames.TryGetValue(RidingMount ? ExAction.MountStanding : ExAction.Standing, out Frame);
                        ...
                        switch (Class)
                        {
                            ...
                            case ExineClass.Assassin:
                                if(ExineMainScene.User.DoubleSlash)
                                    ...
                                    Frames.TryGetValue(CMain.Random.Next(100) >= 20 ? (CMain.Random.Next(100) > 40 ? ExAction.Attack1 : ExAction.Attack4) : (CMain.Random.Next(100) > 10 ? ExAction.Attack2 : ExAction.Attack3), out Frame);
                                else
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.CounterAttack:
                                ...
                                if (this == User)
                                {
                                    ...
                                    ExineMainScene.SpellTime = CMain.Time + 100; //Spell Delay
                                }
                                break;
                            ...
                            case Spell.HeavenlySword:
                                ...
                                if (this == User)
                                {
                                    ...
                                    ExineMainScene.SpellTime = CMain.Time + 1200; //Spell Delay
                                }
                                break;
                            ...
                            case Spell.FlashDash:
                                {
                                    ...
                                    {
                                        Frames.TryGetValue(ExAction.DashAttack, out Frame);
                                        CurrentAction = ExAction.DashAttack;
                            ...
                            case Spell.Stonetrap:
                                ...
                                {
                                    MapControl.NextAction = CMain.Time + 1000;
                                    ExineMainScene.SpellTime = CMain.Time + 1000; //Spell Delay
                                }
                                break;
                            default:
                                Frames.TryGetValue(CurrentAction, out Frame);
                ...
                //Assassin sneekyness
                if (Class == ExineClass.Assassin && Sneaking && (CurrentAction == ExAction.Walking || CurrentAction == ExAction.Running))
                {
                    ...
                    switch (CurrentAction)
                    {
                        ...
                        case ExAction.MountAttack:
                            ...
                            if (Spell == Spell.TwinDrakeBlade)
                                ExineMainScene.User.TwinDrakeBlade = false;
                            if (Spell == Spell.FlamingSword)
                                ExineMainScene.User.FlamingSword = false;
                        ...
                        case ExAction.AttackRange1:
                            {
                                ExineMainScene.AttackTime = CMain.Time + User.AttackSpeed + 200;
                        ...
                        case ExAction.Spell:
                            {
                                ...
                                {
                                    ExineMainScene.SpellTime = CMain.Time + 250;
                                    MapControl.NextAction = CMain.Time;
                                }
                                else
                                {
                                    ExineMainScene.SpellTime = Spell == Spell.FlameField ? CMain.Time + 2500 : CMain.Time + 1800;
                                    MapControl.NextAction = CMain.Time + 2500;
                                }
                            }
                            break;                         
                ...
                switch (CurrentAction)
                {
                    ...
                    case ExAction.DashAttack:
                        ...
                        if (IsDashAttack())
                        {
                            action = new QueuedAction { Action = ExAction.Attack4, Direction = Direction, Location = CurrentLocation, Params = new List<object>() };
                    ...
                    case ExAction.Attack1:
                        ...
                        {
                            case Spell.Slaying:
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == ExineGender.Male ? 0 : 1));
                                break;
                    ...
                    case ExAction.MountStruck:
                        ...
                        for (int i = 0; i < MapControl.Objects.Count; i++)
                        {
                            ...
                            if (player.Class != ExineClass.Assassin || StruckWeapon == -1) break;
                            StruckWeapon = 1;
                            break;
                        }
                        ...
                        PlayFlinchSound();
                        break;
                    case ExAction.AttackRange1: //ArcherTest - Assign Target for other users
                        if (this != User)
                        {
                    ...
                    case ExAction.Dead:
                        ExineMainScene.Scene.Redraw();
                        ExineMainScene.Scene.MapControl.SortObject(this);
        ...
        public virtual void ProcessFrames()
        {
            ...
            switch (CurrentAction)
            {
                ...
                case ExAction.DashAttack:
                    ...
                    {
                        if (this == User) ExineMainScene.Scene.MapControl.TextureValid = false;
                 ...
                 case ExAction.Jump:
                    ...
                    {
                        if (FrameIndex == 1)
                            SoundManager.PlaySound(20000 + 127 * 10 + (Gender == ExineGender.Male ? 5 : 6));
                        if (FrameIndex == 7)
                                                ...
                                                missile.Complete += (o, e) =>
                                                {
                                                    if (ob != null)
                                                    {
                                                        if (Spell == Spell.CrippleShot)
                                                        {
                                                            ...
                                                            if (this == User)
                                                            {
                                                                if (ExineMainScene.Scene.BuffsDialog.Buffs.Any(x => x.Type == BuffType.VampireShot)) exIdx = 20;
                                                                if (ExineMainScene.Scene.BuffsDialog.Buffs.Any(x => x.Type == BuffType.PoisonShot)) exIdx = 10;
                                                            }
                                                            else
                                                            {
                ...
                case ExAction.Die:
                    if (CMain.Time >= NextMotion)
                    {
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            FrameIndex = Frame.Count - 1;
                            ActionFeed.Clear();
                            ActionFeed.Add(new QueuedAction { Action = ExAction.Dead, Direction = Direction, Location = CurrentLocation });
                            SetAction();
                        }
                        else
                        {
                ...
                case ExAction.Revive:
                    if (CMain.Time >= NextMotion)
                    {
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            FrameIndex = Frame.Count - 1;
                            ActionFeed.Clear();
                            ActionFeed.Add(new QueuedAction { Action = ExAction.Standing, Direction = Direction, Location = CurrentLocation });
                            SetAction();
                        }
                        else
                        {
            ...
            if ((CurrentAction == ExAction.Standing || CurrentAction == ExAction.MountStanding || CurrentAction == ExAction.Stance || CurrentAction == ExAction.Stance2 || CurrentAction == ExAction.DashFail) && NextAction != null)
                SetAction();
        ...
        public void PlayStepSound()
        {
            ...
            if (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].FrontIndex > 199) return; //prevents any move sounds on non mir2 maps atm
            if (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleIndex > 199) return; //prevents any move sounds on non mir2 maps atm
            if (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex > 199) return; //prevents any move sounds on non mir2 maps atm

            int moveSound;

            if (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex > 99 && ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex < 199) //shanda tiles
            {
                PlayShandaStepSound(x, y, out moveSound);
            }
            else if (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex > 199 && ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex < 299) //mir3 tiles
            {
        ...
        {
            int index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackImage & 0x1FFFF) - 1;
            ...
            if (index >= 0 && index <= 10000)
            {
                ...
                index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleImage & 0x7FFF) - 1;
                if (index >= 0 && index <= 115)
                    moveSound = SoundList.WalkGroundL;
                else if (index >= 120 && index <= 124)
                    moveSound = SoundList.WalkLawnL;

                index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].FrontImage & 0x7FFF) - 1;
        ...
        private void PlayShandaStepSound(int x, int y, out int moveSound)
        {
            ...
            var tt = ExineMainScene.Scene.MapControl.M2CellInfo[x, y];
            ...
            switch (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex)
            {
                case 100:
                    {
                        //Tiles1
            ...
            index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleImage & 0x1FFFF) - 1;

            #region Middle Tiles
            switch (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleIndex)
            {
                case 114:
                    {
                        //SMTiles5  iJam Ver
            ...
            index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleIndex - 110) * 100000 + index;
        ...
        private void PlayWemadeMir3StepSound(int x, int y, out int moveSound)
        {
            ...
            int backIndex = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackIndex);
            int midIndex = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleIndex);
            int midImage = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleImage & 0x7FFF - 1);

            #region Shanda & Wemade Mir 3
            int index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].BackImage & 0x1FFFF) - 1; // Back
            ...
            index = (ExineMainScene.Scene.MapControl.M2CellInfo[x, y].MiddleImage & 0x7FFF) - 1; // Middle
        ...
        public void GetBackStepDistance(int magicLevel)
        {
            ...
            ExineDirection jumpDir = Functions.ReverseDirection(Direction);

            Point location = CurrentLocation;
            for (int i = 0; i < dist; i++)//step 1t/m3
            {
                location = Functions.PointMove(location, jumpDir, 1);
                if (!ExineMainScene.Scene.MapControl.ValidPoint(location)) break;

                CellInfo cInfo = ExineMainScene.Scene.MapControl.M2CellInfo[location.X, location.Y];
        ...
        public void GetFlashDashDistance(int magicLevel)
        {
            ...
            ExineDirection jumpDir = Direction;
