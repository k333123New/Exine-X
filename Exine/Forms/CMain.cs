...
namespace Exine
{
    ...
    {
        public static ExineControl DebugBaseLabel, HintBaseLabel;
        public static ExineLabel DebugTextLabel, HintTextLabel, ScreenshotTextLabel;
        ...
        public static void CMain_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnKeyDown(e);
        ...
        public static void CMain_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnMouseMove(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnKeyUp(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnKeyPress(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnMouseClick(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnMouseUp(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                ExineTextBox textBox = Program.Form.ActiveControl.Tag as ExineTextBox;

                if (textBox != null && textBox.CanLoseFocus)
                    Program.Form.ActiveControl = null;
            }

            if (e.Button == MouseButtons.Right && (ExineMainScene.SelectedCell != null || ExineMainScene.PickedUpGold))
            {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnMouseDown(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        public static void CMain_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            {
                if (ExineScene.ActiveScene != null)
                    ExineScene.ActiveScene.OnMouseWheel(e);
            }
            catch (Exception ex)
            {
                SaveError(ex.ToString());
        ...
        private static void UpdateEnviroment()
        {
            ...
            if (ExineScene.ActiveScene != null)
                ExineScene.ActiveScene.Process();

            for (int i = 0; i < ExineAnimatedControl.Animations.Count; i++)
                ExineAnimatedControl.Animations[i].UpdateOffSet();

            for (int i = 0; i < ExineAnimatedButton.Animations.Count; i++)
                ExineAnimatedButton.Animations[i].UpdateOffSet();
        ...
        private static void CreateDebugLabel()
        {
            ...
            if (ExineControl.MouseControl != null)
            {
                ...
                if (ExineControl.MouseControl is MapControl)
                    text += string.Format(", Co Ords: {0}", MapControl.MapLocation);

                if (ExineControl.MouseControl is ExineImageControl)
                    text += string.Format(", Control: {0}", ExineControl.MouseControl.GetType().Name);

                if (ExineScene.ActiveScene is ExineMainScene)
                    text += string.Format(", Objects: {0}", MapControl.Objects.Count);

                if (ExineScene.ActiveScene is ExineMainScene && !string.IsNullOrEmpty(DebugText))
                    text += string.Format(", Debug: {0}", DebugText);

                if (ExineObjects.MapObject.MouseObject != null)
                {
                    text += string.Format(", Target: {0}", ExineObjects.MapObject.MouseObject.Name);
                }
                else
                {
            ...
            if (Settings.FullScreen)
            {
                ...
                {
                    DebugBaseLabel = new ExineControl
                    {
        ...
        private static void CreateHintLabel()
        {
            ...
            {
                HintBaseLabel = new ExineControl
                {
            ...
            if (ExineControl.MouseControl == null || string.IsNullOrEmpty(ExineControl.MouseControl.Hint))
            {
            ...
            HintTextLabel.Text = ExineControl.MouseControl.Hint;
        ...
        private static void ToggleFullScreen()
        {
            ...
            if (ExineScene.ActiveScene == ExineMainScene.Scene)
            {
                ExineMainScene.Scene.MapControl.FloorValid = false;
                ExineMainScene.Scene.TextureValid = false;
            }
        ...
        {
            if (CMain.Time < ExineMainScene.LogTime && !Settings.UseTestConfig && !ExineMainScene.Observing)
            {
                ExineMainScene.Scene.ExChatDialog.ReceiveChat(string.Format(GameLanguage.CannotLeaveGame, (ExineMainScene.LogTime - CMain.Time) / 1000), ChatType.System);
                e.Cancel = true;
            }
            else
            {
