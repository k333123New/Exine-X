...
namespace Exine.ExineGraphics
{
    public static class Libraries
    {
        ...
        static Libraries()
        {
            ...
            ExineNPCs[3] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남02_reidx");//안토니오 재단
            ...
            ExineNPCs[8] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남02_reidx");//잭 주점
            ...
            ExineNPCs[12] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남01_reidx");//아론 신관
            ExineNPCs[13] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남01_reidx");//아론 레블리
            ExineNPCs[14] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남01_reidx");//아론 오토
            ExineNPCs[15] = new MLibrary(Settings.ExineNPCPath + "ZM_01_257_성인남01_reidx");//아론 마케르
