...
{
    public sealed class IntelligentCreatureDialog : ExineImageControl
    {
        public ExineImageControl FullnessBG, FullnessFG, FullnessMin, FullnessNow;
        public ExineImageControl PearlImage, BlackStoneImageBG, BlackStoneImageFG;
        public ExineLabel CreatureName, CreatureDeadline, CreaturePearls, CreatureInfo, CreatureInfo1, CreatureInfo2, CreatureMaintainFoodBuff, HoverLabel;
        ...
        public IntelligentCreatureDialog()
        {
            ...
            CreatureImage = new ExineAnimatedControl
            {
                Animated = false,
                AnimationCount = 4,
                AnimationDelay = 250,
            ...
            FullnessBG = new ExineImageControl
            {
                Index = 530,
                Library = Libraries.Prguse2,
            ...
            FullnessFG = new ExineImageControl
            {
                Index = 531,
                Library = Libraries.Prguse2,
                Location = new Point(185, 129),
            ...
            FullnessMin = new ExineImageControl
            {
                Index = 532,
                Library = Libraries.Prguse2,
            ...
            FullnessNow = new ExineImageControl
            {
                Index = 533,
                Library = Libraries.Prguse2,
            ...
            PearlImage = new ExineImageControl
            {
                Index = 427,
                Library = Libraries.Prguse2,
            ...
            BlackStoneImageBG = new ExineImageControl
            {
                Index = 428,
                Library = Libraries.Prguse2,
            ...
            BlackStoneImageFG = new ExineImageControl
            {
                Index = 420,
                Library = Libraries.Prguse2,
            ...
            CreatureDeadline = new ExineLabel
            {
                Parent = this,
            ...
            CreatureMaintainFoodBuff = new ExineLabel
            {
                Parent = this,
        ...
        private void FullnessForeGround_AfterDraw(object sender, EventArgs e)
        {
            ...
            double percent = ExineMainScene.User.IntelligentCreatures[selectedCreature].Fullness / ((double)10000);
            ...
            if (HoverLabel.Visible && HoverLabelParent != null && HoverLabelParent == FullnessFG)
                HoverLabel.Text = ExineMainScene.User.IntelligentCreatures[selectedCreature].Fullness.ToString() + " / 10000";
            ...
            percent = ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules.MinimalFullness / ((double)10000);
        ...
        private void BlackStoneImageFG_AfterDraw(object sender, EventArgs e)
        {
            ...
            double percent = ExineMainScene.User.IntelligentCreatures[selectedCreature].BlackstoneTime / ((double)blackstoneProduceTime);
            if (percent > 1) percent = 1;
            if (percent <= 0) return;

            if (HoverLabel.Visible && HoverLabelParent != null && HoverLabelParent == BlackStoneImageFG)
            {
                if (ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules.CanProduceBlackStone)
                    HoverLabel.Text = string.Format("{0}", Functions.PrintTimeSpanFromSeconds(blackstoneProduceTime - ExineMainScene.User.IntelligentCreatures[selectedCreature].BlackstoneTime));
                else
        ...
        private void Control_MouseEnter(object sender, EventArgs e)
        {
            ...
            if (sender == FullnessMin)
            {
                ...
                HoverLabel.Text = "Needed " + ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules.MinimalFullness.ToString();
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            if (sender == CreatureRenameButton)
            {
                ...
                inputBox.InputTextBox.Text = ExineMainScene.User.IntelligentCreatures[selectedCreature].CustomName;
                inputBox.OKButton.Click += (o1, e1) =>
                {
                    ...
                    else
                    {
                        ...
                        ExineMainScene.User.IntelligentCreatures[selectedCreature].CustomName = inputBox.InputTextBox.Text;
                        Network.Enqueue(new C.UpdateIntelligentCreature { Creature = ExineMainScene.User.IntelligentCreatures[selectedCreature] });
                        inputBox.Dispose();
                    }
                };
            ...
            if (sender == ReleaseButton)
            {
                ...
                {
                    if (String.Compare(verificationBox.InputTextBox.Text, ExineMainScene.User.IntelligentCreatures[selectedCreature].CustomName, StringComparison.OrdinalIgnoreCase) != 0)
                    {
                        ExineMainScene.Scene.ExChatDialog.ReceiveChat("Verification Failed!!", ChatType.System);
                    }
                    else
                    {
                        ...
                        Hide();
                        Network.Enqueue(new C.UpdateIntelligentCreature { Creature = ExineMainScene.User.IntelligentCreatures[selectedCreature], ReleaseMe = true });
                    }
            ...
            if (sender == SemiAutoModeButton)
            {
                ...
                if (!ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules.AutoPickupEnabled) return;

                //turn on automatic pickupmode
                SemiAutoModeButton.Visible = false;
                AutomaticModeButton.Visible = true;
                ExineMainScene.User.IntelligentCreatures[selectedCreature].petMode = IntelligentCreaturePickupMode.Automatic;
                needUpdate = true;
            }
            if (sender == AutomaticModeButton)
            {
                //make sure rules allow SemiAutomatic Mode
                if (!ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules.SemiAutoPickupEnabled) return;

                //turn on semiauto pickupmode
                AutomaticModeButton.Visible = false;
                SemiAutoModeButton.Visible = true;
                ExineMainScene.User.IntelligentCreatures[selectedCreature].petMode = IntelligentCreaturePickupMode.SemiAutomatic;
                needUpdate = true;
            }
            if (sender == OptionsMenuButton)
            {
                //show ItemFilter
                if (!ExineMainScene.Scene.IntelligentCreatureOptionsDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsDialog.Show(ExineMainScene.User.IntelligentCreatures[selectedCreature].Filter);
                if (!ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Show(ExineMainScene.User.IntelligentCreatures[selectedCreature].Filter.PickupGrade);
            }

            if (needUpdate)
            {
                Update();//refresh changes
                Network.Enqueue(new C.UpdateIntelligentCreature { Creature = ExineMainScene.User.IntelligentCreatures[selectedCreature], SummonMe = needSummon, UnSummonMe = needDismiss, ReleaseMe = needRelease });
            }
        }
        ...
        {
            CreaturePearls.Text = ExineMainScene.User.PearlCount.ToString();

            int SelectedButton = -1;

            for (int i = 0; i < CreatureButtons.Length; i++)
            {
                if (i >= ExineMainScene.User.IntelligentCreatures.Count)
                {
                ...
                CreatureButtons[i].Update(ExineMainScene.User.IntelligentCreatures[i], showing);

                //Check what creature is currently summoned if at all
                if (showing && ExineMainScene.User.CreatureSummoned && CreatureButtons[i].PetType == ExineMainScene.User.SummonedCreatureType) SelectedButton = i;
            }
            showing = false;
        ...
        private void RefreshUI()
        {
            ...
            else
            {
                ...
                if (ExineMainScene.User.CreatureSummoned)
                {
                    if (ExineMainScene.User.IntelligentCreatures[selectedCreature].PetType == ExineMainScene.User.SummonedCreatureType)
                    {
        ...
        private void RefreshMode()
        {
            ...
            if (ExineMainScene.User.IntelligentCreatures[selectedCreature].petMode == IntelligentCreaturePickupMode.Automatic)
            {
                AutomaticModeButton.Visible = true;
                SemiAutoModeButton.Visible = false;
            }
        ...
        private void DrawCreatureAnimation()
        {
            ...
            var rules = ExineMainScene.User.IntelligentCreatures[selectedCreature].CreatureRules;
            ...
            CreatureName.Text = ExineMainScene.User.IntelligentCreatures[selectedCreature].CustomName;
            ...
            //Expire
            if (ExineMainScene.User.IntelligentCreatures[selectedCreature].Expire == DateTime.MinValue)
            {
                CreatureDeadline.Text = string.Format(GameLanguage.ExpireNever);
            }
            else
            {
                var seconds = (ExineMainScene.User.IntelligentCreatures[selectedCreature].Expire - CMain.Now).TotalSeconds;

                CreatureDeadline.Text = string.Format(GameLanguage.Expire, Functions.PrintTimeSpanFromSeconds(seconds));
            }

            if (ExineMainScene.User.IntelligentCreatures[selectedCreature].MaintainFoodTime == 0)
                CreatureMaintainFoodBuff.Text = "0";
            else
                CreatureMaintainFoodBuff.Text = string.Format("FoodBuff: {0}", Functions.PrintTimeSpanFromSeconds(ExineMainScene.User.IntelligentCreatures[selectedCreature].MaintainFoodTime));
        ...
        {
            for (int i = 0; i < ExineMainScene.User.IntelligentCreatures.Count; i++)
            {
                if (ExineMainScene.User.IntelligentCreatures[i].SlotIndex == slotidx) return i;
            }
            return -1;
        }
        #endregion
        ...
        public void SaveItemFilter(IntelligentCreatureItemFilter filter)
        {
            ...
            ExineMainScene.User.IntelligentCreatures[selectedCreature].Filter = filter;
            Network.Enqueue(new C.UpdateIntelligentCreature { Creature = ExineMainScene.User.IntelligentCreatures[selectedCreature] });
        }
        ...
        {
            base.OnMouseDown(e);
            if (ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.BringToFront();
            if (ExineMainScene.Scene.IntelligentCreatureOptionsDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsDialog.BringToFront();
        }

        public override void Hide()
        {
            if (!Visible) return;
            if (ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Hide();
            if (ExineMainScene.Scene.IntelligentCreatureOptionsDialog.Visible) ExineMainScene.Scene.IntelligentCreatureOptionsDialog.Hide();
            AnimSwitched = false;
            AnimNeedSwitch = false;
            Visible = false;
        ...
        public override void Show()
        {
            ...
            if (!ExineMainScene.User.IntelligentCreatures.Any())
            {
    ...
    public sealed class CreatureButton : ExineControl
    {
        public ExineImageControl SelectionImage;
        ...
        public CreatureButton()
        {
            ...
            SelectionImage = new ExineImageControl
            {
                Index = 535,
                Library = Libraries.Prguse2,
        ...
        {
            if (Selected) return;
            for (int i = 0; i < ExineMainScene.Scene.IntelligentCreatureDialog.CreatureButtons.Length; i++)
            {
                if (i == idx) continue;

                //ExineMainScene.Scene.IntelligentCreatureDialog.CreatureButtons[i].SelectButton(false); //add k333123 remove
                
            }

            SelectButton(true);
            ExineMainScene.Scene.IntelligentCreatureDialog.SelectedCreatureSlot = idx;
            ExineMainScene.Scene.IntelligentCreatureDialog.SwitchAnimTime = CMain.Time + 10000;
            ExineMainScene.Scene.IntelligentCreatureDialog.AnimSwitched = false;
            ExineMainScene.Scene.IntelligentCreatureDialog.AnimNeedSwitch = false;
            ExineMainScene.Scene.IntelligentCreatureDialog.Update();
        }
    ...
    public sealed class IntelligentCreatureOptionsDialog : ExineImageControl
    {
        ...
        public IntelligentCreatureOptionsDialog()
        {
            ...
            Movable = false;
            Sort = true;
            Location = new Point(ExineMainScene.Scene.IntelligentCreatureDialog.Location.X + locationOffset.X, ExineMainScene.Scene.IntelligentCreatureDialog.Location.Y + locationOffset.Y);
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            {
                Filter.PickupGrade = ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.GradeType;
                ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Hide();
                ExineMainScene.Scene.IntelligentCreatureDialog.SaveItemFilter(Filter);
                Hide();
            }
            if (sender == OptionsCancelButton)
            {
                Filter = new IntelligentCreatureItemFilter();
                ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.GradeType = ItemGrade.None;
                ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.RefreshGradeFilter();
                ExineMainScene.Scene.IntelligentCreatureOptionsGradeDialog.Hide();
                RefreshFilter();
                Hide();
            }
