...
{
    public sealed class RollDialog : ExineControl
    {
        private readonly ExineAnimatedControl _animation;
        ...
        public RollDialog()
        {
            ...
            _animation = new ExineAnimatedControl
            {
                Parent = this,
                Index = 0,
        ...
        private void ReturnResult()
        {
            ...
            Network.Enqueue(new C.CallNPC { ObjectID = ExineMainScene.NPCID, Key = $"[{_npcPage}]" });
        }
    }
}
