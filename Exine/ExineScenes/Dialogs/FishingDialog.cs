...
{
    public sealed class FishingDialog : ExineImageControl
    {
        public ExineLabel TitleLabel;
        public MirButton CloseButton;
        public MirItemCell[] Grid;

        public ExineControl FishingRod;
        ...
        void FishingRod_BeforeDraw(object sender, EventArgs e)
        {
            ...
            if (MapObject.User.HasFishingRod)
            {
                ...
                if (ExineMainScene.User.Weapon == 49)
                    FishingImage = 1333;
                else if (ExineMainScene.User.Weapon == 50)
                    FishingImage = 1335;
    ...
    public sealed class FishingStatusDialog : ExineImageControl
    {
        public ExineImageControl TitleLabel, AutoCastBox, ESCTick, ESCExit, FishDisableButton;
        public ExineControl ChanceBar, ProgressBar;
        public ExineLabel ChanceLabel;
        ...
        public FishingStatusDialog()
        {
            ...
            FishDisableButton = new ExineImageControl
            {
                Index = 149,
            ...
            FishButton = new ExineAnimatedButton()
            {
                Animated = true,
                AnimationCount = 10,
                Loop = true,
            ...
            AutoCastBox = new ExineImageControl
            {
                Index = 1343,
