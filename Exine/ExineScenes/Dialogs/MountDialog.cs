...
{
    public sealed class MountDialog : ExineImageControl
    {
        public ExineLabel MountName, MountLoyalty;
        public MirButton CloseButton, MountButton, HelpButton;
        private ExineAnimatedControl MountImage;
        ...
        public MountDialog()
        {
            ...
            HelpButton.Click += (o, e) => ExineMainScene.Scene.HelpDialog.DisplayPage("Mounts");
        ...
        {
            UserItem MountItem = ExineMainScene.User.Equipment[(int)EquipmentSlot.Mount];
        ...
        {
            if (ExineMainScene.User.MountType < 0)
            {
                MountImage.Index = 0;
            ...
            {
                MountImage.Index = StartIndex + (ExineMainScene.User.MountType * 20);
        ...
        public bool CanRide()
        {
            if (ExineMainScene.User.MountType < 0 || ExineMainScene.User.MountTime + 500 > CMain.Time) return false;
            if (ExineMainScene.User.CurrentAction != ExAction.Standing && ExineMainScene.User.CurrentAction != ExAction.MountStanding) return false;
