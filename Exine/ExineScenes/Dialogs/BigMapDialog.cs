...
namespace Exine.ExineScenes.Dialogs
{
    public sealed class BigMapDialog : ExineImageControl
    {
        ...
        public BigMapNPCRow SelectedNPC
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    var map = ExineMainScene.Scene.MapControl;
        ...
        public BigMapRecord CurrentRecord
        {
            ...
            set
            {
                ...
                ViewPort.UserRadarDot.Visible = currentRecord != null && currentRecord.Index == ExineMainScene.Scene.MapControl.Index;
        ...
        public BigMapDialog()
        {
            ...
            CoordinateLabel = new ExineLabel
            {
                AutoSize = true,
    ...
    public class WorldMapImage : ExineImageControl
    {
        ...
        public void MakeButtons(List<WorldMapIcon> icons)
        {
            foreach (WorldMapIcon icon in icons)
            {
                ...
                button.Click += (o, e) =>
                {
                    ExineMainScene.Scene.BigMapDialog.SetTargetMap(icon.MapIndex);
                };
    ...
    public sealed class BigMapViewPort : ExineControl
    {
        BigMapDialog ParentDialog;
        float ScaleX;
        float ScaleY;
        public ExineImageControl SelectedNPCIcon, UserRadarDot;

        int BigMap_MouseCoordsProcessing_OffsetX, BigMap_MouseCoordsProcessing_OffsetY;

        public ExineImageControl[] Players;
        ...
        public BigMapViewPort()
        {
            ...
            SelectedNPCIcon = new ExineImageControl
            {
                Library = Libraries.MapLinkIcon,
                NotControl = false,
                Parent = this,
            ...
            UserRadarDot = new ExineImageControl
            {
                Library = Libraries.Prguse2,
                Index = 1350,
                Parent = this,
            ...
            Players = new ExineImageControl[Globals.MaxGroup];
            for (int i = 0; i < Players.Length; i++)
            {
                Players[i] = new ExineImageControl
                {
                    Index = 1350,
                    Library = Libraries.Prguse2,
                    Parent = this,
        ...
        private void OnMouseClick(object sender, MouseEventArgs e)
        {
            ...
            var path = ExineMainScene.Scene.MapControl.PathFinder.FindPath(MapObject.User.CurrentLocation, new Point(X, Y));
        ...
        private void OnBeforeDraw()
        {
            ...
            BigMapRecord currentRecord = new BigMapRecord();
            //add k333123 remove
            /*
            BigMapRecord currentRecord;
            if (!ExineMainScene.MapInfoList.TryGetValue(ParentDialog.TargetMapIndex, out currentRecord))
                return;
            */
            ...
            if (ParentDialog.TargetMapIndex == map.Index)
            {
                ...
                {
                    for (int i = 0; i < ExineMainScene.Scene.GroupDialog.GroupMembers.Length; i++)
                    {
                        string groupMembersName = ExineMainScene.Scene.GroupDialog.GroupMembers[i].Text;
