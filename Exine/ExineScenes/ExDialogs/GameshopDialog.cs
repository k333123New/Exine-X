...
{
    public sealed class GameShopDialog : ExineImageControl
    {
        public GameShopViewer Viewer;
        public ExineLabel PageNumberLabel, totalGold, totalCredits;
        ...
        public ExineLabel[] Filters = new ExineLabel[22];
        List<String> CategoryList = new List<String>();
        List<GameShopItem> filteredShop = new List<GameShopItem>();
        List<GameShopItem> SearchResult = new List<GameShopItem>();
        public ExineTextBox Search;
        public ExineImageControl TitleLabel, FilterBackground;
        ...
        {
            ExineMainScene.GameShopInfoList.Clear();
            Index = 749;
            ...
            FilterBackground = new ExineImageControl
            {
                Index = 769,
                Library = Libraries.Title,
        ...
        public override void Show()
        {
            if (Visible) return;
            Visible = true;
            ClassFilter = ExineMainScene.User.Class.ToString();
            SectionFilter = "Show All";
            ResetTabs();
            ResetClass();
            GetCategories();
        ...
        public void Process()
        {
            totalCredits.Text = ExineMainScene.Credit.ToString("###,###,##0");
            totalGold.Text = ExineMainScene.Gold.ToString("###,###,##0");
        }
        ...
        public void GetCategories()
        {
            ...
            if (Search.TextBox.Text != "")
                shopList = ExineMainScene.GameShopInfoList.Where(f => f.Info.FriendlyName.ToLower().Contains(Search.TextBox.Text.ToLower())).ToList();
            else
                shopList = ExineMainScene.GameShopInfoList;
        ...
        public void UpdateShop()
        {
            ...
            ExineMainScene.Scene.GameShopDialog.Viewer.Visible = false;
