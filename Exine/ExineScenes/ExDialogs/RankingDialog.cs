...
namespace Exine.ExineScenes.ExDialogs
{
    public class RankingDialog : ExineImageControl
    {
        ...
        public sealed class RankingRow : ExineControl
        {
            public RankCharacterInfo Listing;
            public ExineLabel RankLabel, NameLabel, LevelLabel, ClassLabel;
            public long Index;
            ...
            public void Inspect()
            {
                if (CMain.Time <= ExineMainScene.InspectTime/* && Index == InspectDialog.InspectID*/) return;
            ...
            public void Update(RankCharacterInfo listing, int RankIndex)
            {
                ...
                else if (NameLabel.Text == ExineMainScene.User.Name)
                {
