...
{
    public sealed class ItemRentalDialog : ExineImageControl
    {
        ...
        public ItemRentalDialog()
        {
            ...
            var windowTitle = new ExineImageControl
            {
                Index = 0,
                Library = Libraries.Prguse3,
        ...
        private sealed class ItemRow : ExineControl
        {
            private readonly ExineLabel _itemNameLabel, _rentingPlayerLabel, _returnDateLabel;

            public ItemRow()
            {
                _itemNameLabel = new ExineLabel
                {
                ...
                _rentingPlayerLabel = new ExineLabel
                {
                    Size = new Size(128, 20),
                ...
                _returnDateLabel = new ExineLabel
                {
                    Size = new Size(128, 20),
