...
{
    public class BuffDialog : ExineImageControl
    {
    ...
    protected const long FadeDelay = 55;
        ...
        public BuffDialog()
        {
            ...
            _buffCountLabel = new ExineLabel
            {
                Parent = this,
                AutoSize = true,
        ...
        public void CreateBuff(ClientBuff buff)
        {
            ...
            var image = new ExineImageControl
            {
                Library = buffLibrary,
                Parent = this,
                Visible = true,
        ...
        public string BuffString(ClientBuff buff)
        {
            ...
            switch (buff.Type)
            {
                ...
                case BuffType.Mentee:
                    ...
                    break;
                case BuffType.Guild:
                    text += ExineMainScene.Scene.GuildDialog.ActiveStats;
                    break;
    ...
    public sealed class PoisonBuffDialog : ExineImageControl
    {
