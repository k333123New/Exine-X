...
{
    public sealed class ItemRentingDialog : ExineImageControl
    {
        ...
        private readonly ExineLabel _nameLabel, _rentalPeriodLabel;
        ...
        public ItemRentingDialog()
        {
            ...
            _rentalPeriodLabel = new ExineLabel
            {
                Parent = this,
        ...
        {
            var inputBox = new MirInputBox($"How long would you like to rent {RentalItem.FriendlyName} to {ExineMainScene.Scene.GuestItemRentDialog.GuestName} for? (1 to 30 days).");
        ...
        public void OpenItemRentalDialog()
        {
            ...
            Show();
            RefreshInterface();
            ExineMainScene.Scene.GuestItemRentDialog.Show();
        }
        ...
        public void Reset()
        {
            ...
            ExineMainScene.Scene.GuestItemRentingDialog.Reset();
    ...
    public sealed class GuestItemRentingDialog : ExineImageControl
    {
        ...
        public void RefreshInterface()
        {
            ...
            if (GuestLoanItem != null)
                ExineMainScene.Bind(GuestLoanItem);
