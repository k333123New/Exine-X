...
{
    public sealed class KeyboardLayoutDialog : ExineImageControl
    {
        ...
        public KeyboardLayoutDialog()
        {
            ...
            EnforceButtonChecked = new ExineImageControl()
            {
                Visible = Enforce,
                Index = 1347,
                Library = Libraries.Prguse,
            ...
            EnforceButtonLabel = new ExineLabel
            {
                Visible = true,
                NotControl = true,
                Parent = this,
        ...
        {
            foreach (ExineControl t in Rows)
                t.Dispose();
    ...
    public sealed class KeybindRow : ExineControl
    {
        ...
        public KeybindRow(KeybindOptions option)
        {
            ...
            CurrentBindButton.Click += (o, e) =>
            {
                ...
                {
                    ExineMainScene.Scene.KeyboardLayoutDialog.WaitingForBind = null;
                    ExineMainScene.Scene.KeyboardLayoutDialog.UpdateText();
                    return;
                }
    ...
    public sealed class KeybindHeadingRow : ExineControl
    {
        public ExineImageControl BulletImage, SpacerImage;
        public ExineLabel BulletLabel;

        public KeybindHeadingRow(string groupName)
        {
            BulletImage = new ExineImageControl
            {
                Parent = this,
                Index = 201,
                Library = Libraries.Prguse2,
            ...
            SpacerImage = new ExineImageControl
            {
                Parent = this,
                Index = 202,
                Library = Libraries.Prguse2,
