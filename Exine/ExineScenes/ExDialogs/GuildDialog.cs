    ...
    public sealed class GuildDialog : ExineImageControl
    {
        ...
        public void RequestBuff(byte Id)
        {
            ...
            if (Buff == null)
            {
                ...
                Network.SendPacketToServer(new ClientPacket.GuildBuffUpdate { Action = 1, Id = BuffInfo.Id });
            }
            else
            {
                string Error = "";
                ...
                if (CMain.Time < LastRequest + 100) return;
                LastRequest = CMain.Time;
                Network.SendPacketToServer(new ClientPacket.GuildBuffUpdate { Action = 2, Id = BuffInfo.Id });
            }
        }
        ...
        public void RequestGuildBuffList()
        {
            ...
            {
                RequestedList = true;
                Network.SendPacketToServer(new ClientPacket.GuildBuffUpdate { Action = 0 });
            }
        }
        ...
        public void EditNotice()
        {
            ...
            else
            {
                ...
                Network.SendPacketToServer(new ClientPacket.EditGuildNotice() { notice = Notice.MultiText.ToList() });
            }
        }
        ...
        public void OnNewRank(int Index, int SelectedIndex)
        {
            ...
            {
                Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 2, Name = MembersName[Index].Text, RankIndex = (byte)Ranks[SelectedIndex].Index, RankName = Ranks[SelectedIndex].Name });
        ...
        public void AddMember()
        {
            ...
            if (LastGuildMsg > CMain.Time) return;
            Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 0, Name = MembersRecruitName.Text });
            LastGuildMsg = CMain.Time + 5000;
        ...
        public void DeleteMember(int Index)
        {
            ...
            messageBox.YesButton.Click += (o, a) =>
            {
                Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 1, Name = MembersName[Index].Text });
                LastGuildMsg = CMain.Time + 5000;
            };
            messageBox.Show();
        }
        ...
        public void OnRankSelect(int Index)
        {
            ...
            else
            {
                ...
                messageBox.YesButton.Click += (o, a) =>
                {
                    Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 4, RankName = String.Format("Rank-{0}", Ranks.Count - 1) });
                    LastGuildMsg = CMain.Time + 5000;
                };
                messageBox.Show();
            }
        ...
        public void SwitchRankOption(int OptionIndex)
        {
            ...
            if (LastGuildMsg > CMain.Time) return;
            Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 5, RankIndex = (byte)Ranks[RanksSelectBox.SelectedIndex].Index, RankName = OptionIndex.ToString(), Name = RanksOptionsStatus[OptionIndex].Visible ? "false" : "true" });
        ...
        public void RanksChangeName()
        {
            ...
            {
                Network.SendPacketToServer(new ClientPacket.EditGuildMember { ChangeType = 3, RankIndex = (byte)Ranks[RanksSelectBox.SelectedIndex].Index, RankName = RanksName.Text });
        ...
        public void StorageAddGold()
        {
            ...
            amountBox.OKButton.Click += (o, a) =>
            {
                ...
                Network.SendPacketToServer(new ClientPacket.GuildStorageGoldChange
                {
                    Type = 0,
        ...
        public void RequestUpdateNotice()
        {
            if ((NoticeChanged) && (LastNoticeRequest < CMain.Time))
            {
                ...
                Network.SendPacketToServer(new ClientPacket.RequestGuildInfo() { Type = 0 });
            }
        }
        public void RequestUpdateMembers()
        {
            if ((MembersChanged) && (LastMemberRequest < CMain.Time))
            {
                ...
                Network.SendPacketToServer(new ClientPacket.RequestGuildInfo() { Type = 1 });
            }
        }
        #endregion
        ...
        public void LeftDialog(byte Lpageid)
        {
            ...
            switch (Lpageid)
            {
                ...
                case 2:
                    ...
                    Network.SendPacketToServer(new ClientPacket.GuildStorageItemChange() { Type = 3 });
                    break;
                case 3:
