...
{
    public sealed class HelpDialog : ExineImageControl
    {
    ...
    public class ShortcutInfoPage : ExineControl
    {
        ...
        public ShortcutInfoPage()
        {
            ...
            ExineLabel shortcutTitleLabel = new ExineLabel
            {
                Text = "Shortcuts",
            ...
            ExineLabel infoTitleLabel = new ExineLabel
            {
                Text = "Information",
                DrawFormat = TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter,
                ForeColour = Color.White,
        ...
        public void LoadKeyBinds()
        {
            ...
            {
                ExineLabel shortcutLabel = new ExineLabel
                {
                ...
                ExineLabel informationLabel = new ExineLabel
                {
    ...
    public class HelpPage : ExineControl
    {
        public string Title;
        public int ImageID;
        public ExineControl Page;

        public ExineLabel PageTitleLabel;

        public HelpPage(string title, int imageID, ExineControl page)
        {
            Title = title;
            ImageID = imageID;
            Page = page;
