...
{
    public sealed class TrustMerchantDialog : ExineImageControl
    {
        ...
        public ExineTextBox SearchTextBox, PriceTextBox;
        ...
        public ExineLabel ItemLabel, PriceLabel, SellerLabel, PageLabel;
        public ExineLabel DateLabel, ExpireLabel;
        public ExineLabel NameLabel, TotalPriceLabel, SplitPriceLabel;
        public ExineLabel HelpLabel;
        public ExineLabel TitleSalePriceLabel, TitleSellLabel, TitleItemLabel, TitlePriceLabel, TitleExpiryLabel;
        ...
        public ExineImageControl FilterBox, FilterBackground;
        ...
        private ExineLabel TotalGold;

        public List<Filter> Filters = new List<Filter>();

        List<MirButton> FilterButtons = new List<MirButton>();
        List<ExineLabel> FilterLabels = new List<ExineLabel>();
        ...
        public TrustMerchantDialog()
        {
            ...
            SearchTextBox = new ExineTextBox
            {
            ...
            TitleSalePriceLabel = new ExineLabel
            {
                Text = "SALE PRICE",
                Parent = this,
            ...
            TitlePriceLabel = new ExineLabel
            {
                Text = "PRICE",
                Parent = this,
                Font = new Font(Settings.FontName, Settings.FontSize - 1, FontStyle.Italic),
            ...
            TitleExpiryLabel = new ExineLabel
            {
                Text = "EXPIRY",
                Parent = this,
                Font = new Font(Settings.FontName, Settings.FontSize - 1, FontStyle.Italic),
        ...
        public void UpdateInterface()
        {
            ...
            TotalGold.Text = MarketType == MarketPanelType.GameShop ? ExineMainScene.Credit.ToString("###,###,##0") : ExineMainScene.Gold.ToString("###,###,##0");
        ...
        private void ItemCell_Click()
        {
            ...
            if (ExineMainScene.SelectedCell == null || ExineMainScene.SelectedCell.GridType != MirGridType.Inventory ||
                  ExineMainScene.SelectedCell.Item != null && ExineMainScene.SelectedCell.Item.Info.Durability < 0)
                return;

            SellItemSlot = ExineMainScene.SelectedCell.Item;
            tempCell = ExineMainScene.SelectedCell;
        ...
        #region AuctionRow
        public sealed class AuctionRow : ExineControl
        {
            public ClientAuction Listing = null;

            public ExineLabel NameLabel, PriceLabel, SellerLabel, ExpireLabel;
            public ExineImageControl IconImage, SelectedImage;
            ...
            public void Update(ClientAuction listing)
            {
                ...
                NameLabel.ForeColour = ExineMainScene.Scene.GradeNameColor(Listing.Item.Info.Grade);
            ...
            protected override void OnMouseEnter()
            {
                ...
                base.OnMouseEnter();
                ExineMainScene.Scene.CreateItemLabel(Listing.Item);
            }
