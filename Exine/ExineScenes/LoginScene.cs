...
{
    public sealed class LoginScene : ExineScene
    {
        ...
        public LoginScene()
        {
            ...
            TestLabel = new ExineImageControl
            {
                Index = 79,
        ...
        public sealed class LoginDialog : ExineImageControl
        {
            public ExineImageControl TitleLabel, AccountIDLabel, PassLabel;
            public MirButton AccountButton, CloseButton, OKButton, PassButton, ViewKeyButton;
            public ExineTextBox AccountIDTextBox, PasswordTextBox;
            ...
            public LoginDialog()
            {
                ...
                AccountIDLabel = new ExineImageControl
                    {
                        Index = 31,
                        Library = Libraries.Title,
                        Parent = this,
                ...
                PassLabel = new ExineImageControl
                    {
                        Index = 32,
                        Library = Libraries.Title,
                        Parent = this,
                ...
                PasswordTextBox = new ExineTextBox
                {
                ...
                AccountIDTextBox = new ExineTextBox
                {
        ...
        public sealed class InputKeyDialog : ExineImageControl
        {
            ...
            public InputKeyDialog(LoginDialog loginDialog)
            {
                ...
                Index = 1080;
                Library = Libraries.Prguse;
                Location = new Point((Exine.Settings.ScreenWidth - Size.Width) / 2 + 285, (Exine.Settings.ScreenHeight - Size.Height) / 2 + 150);
                Visible = true;
            ...
            {
                ExineTextBox currentTextBox = GetFocussedTextBox();
            ...
            private ExineTextBox GetFocussedTextBox()
            {
        ...
        public sealed class NewAccountDialog : ExineImageControl
        {
            public MirButton OKButton, CancelButton;

            public ExineTextBox AccountIDTextBox,
                              Password1TextBox,
                              Password2TextBox,
                              EMailTextBox,
                              UserNameTextBox,
            ...
            public NewAccountDialog()
            {
                ...
                Password1TextBox = new ExineTextBox
                {
                    Border = true,
                ...
                Password2TextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                UserNameTextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                BirthDateTextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                QuestionTextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                AnswerTextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
        ...
        public sealed class ChangePasswordDialog : ExineImageControl
        {
            public readonly MirButton OKButton,
                                      CancelButton;

            public readonly ExineTextBox AccountIDTextBox,
            ...
            public ChangePasswordDialog()
            {
                ...
                CurrentPasswordTextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                NewPassword1TextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
                ...
                NewPassword2TextBox = new ExineTextBox
                {
                    Border = true,
                    BorderColour = Color.Gray,
