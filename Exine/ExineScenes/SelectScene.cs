...
{
    public class SelectScene : ExineScene
    {
        public ExineImageControl Background, Title;
        private NewCharacterDialog _character;

        public ExineLabel ServerLabel;
        public ExineAnimatedControl CharacterDisplay;
        ...
        public ExineLabel LastAccessLabel, LastAccessLabelLabel;
        ...
        public SelectScene(List<SelectInfo> characters)
        {
            ...
            CharacterDisplay = new ExineAnimatedControl
            {
                Animated = true,
                AnimationCount = 16,
                AnimationDelay = 250,
            ...
            LastAccessLabel = new ExineLabel
            {
            ...
            LastAccessLabelLabel = new ExineLabel
            {
        ...
        public void StartGame()
        {
            if (!Libraries.Loaded)
            {
                ExineAnimatedControl loadProgress = new ExineAnimatedControl
                {
                    Library = Libraries.Prguse,
                    Index = 940,
                    Visible = true,
        ...
        private void UpdateInterface()
        {
            ...
            if (_selected >= 0 && _selected < Characters.Count)
            {
                ...
                switch ((ExineClass)Characters[_selected].Class)
                {
        ...
        #endregion        
        public sealed class CharacterButton : ExineImageControl
        {
            public ExineLabel NameLabel, LevelLabel, ClassLabel;
