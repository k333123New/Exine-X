...
namespace MyApp
{
    ...
    class FrameInfo
    {
        ...
        { 
            ...
            {
                if (frames[i].FrameHeight==0 && frames[i].FrameWidth == 0)
                {
                    //프레임 크기 정보 가능성이 높음 
                } 
    ...
    class Frame
    {
        ...
        public int FillData(byte[] datas, int idx, int version, int dataPotision, bool hasPalette, byte[] palette)
        {
            ...
            if (HasAlpha)
            {
                ...
                if (hasPalette)
                {
                    Console.WriteLine("hasPalette");
                    //idx=0;
                    colorData = new byte[FrameWidth * FrameHeight * 2];
                    //colorData = new byte[FrameWidth * FrameHeight * 4];
                    for(int i=0;i<colorData.Length;i++)
                    {
                        colorData[i] = (byte)0xff;
                    }
                    ...
                    for (int i = 0; i < AlphaMask.Length; i++)
                    {
                        ...
                        else
                        {
                            if (baseOffset == 0)
                            {
                                Console.WriteLine("(baseOffset == 0)");
                                colorData[i * 2] = 0x00;
                ...
                else
                {
                    ...
                    for (int i = 0; i < AlphaMask.Length; i++)
                    {
                        ...
                        if (AlphaMask[i] == 0x00)
                        {
                            //Console.WriteLine("AlphaMask[i] == 0x00");
                            //Magenta
        ...
        public bool SaveImage(string filename)
        {
            ...
            {
                Console.WriteLine("Height : " + FrameHeight + " Width:" + FrameWidth);
                //Console.ReadLine();
            }
