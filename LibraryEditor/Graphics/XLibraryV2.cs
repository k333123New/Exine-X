...
namespace LibraryEditor
{
    ...
    /// </summary>
    public sealed class XLibraryV2
    {
        ...
        public XLibraryV2(string filename)
        {
            FileName = filename;
            Initialize();
            Close();
        ...
        public void Initialize()
        {
            ...
            if (CurrentVersion >= 3)
            {
                ...
                {
                    Frames.Add((ExAction)_reader.ReadByte(), new Frame(_reader));
                }
            }
        }
        ...
        {
            ExineImage mImage = new ExineImage(image, maskImage) { X = x, Y = y };
        ...
        {
            ExineImage mImage = new ExineImage(image, removeBlack) { X = x, Y = y };
        ...
        public sealed class ExineImage
        {
            ...
            public ExineImage(Bitmap image, bool removeBlack = true)
            {
                if (image == null)
                {
                    FBytes = new byte[0];
