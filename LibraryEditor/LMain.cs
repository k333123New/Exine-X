...
namespace LibraryEditor
{
    public partial class LMain : Form
    {
        ...
        public LMain()
        {
            ...
            this.FrameAction.ValueType = typeof(ExAction);
            this.FrameAction.DataSource = Enum.GetValues(typeof(ExAction));
        ...
        private void UpdateFrameGridData()
        {
            ...
            foreach (DataGridViewRow row in frameGridView.Rows)
            {
                ...
                var action = (ExAction)row.Cells["FrameAction"].Value;
        ...
        private ExineDirection _currentDirection;
        ...
        private void FrameAnimTimer_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _currentFrame = 0;
                    ExineDirection[] arr = (ExineDirection[])Enum.GetValues(typeof(ExineDirection));
                    int j = Array.IndexOf<ExineDirection>(arr, _currentDirection) + 1;
