...
namespace Server.ExineObjects
{
    public class HumanObject : MapObject
    {
        ...
        protected ExineConnection connection;
        public virtual ExineConnection Connection
        {
        ...
        public ExineStyle ExStyle
        {
            get { return Info.ExStyle; }
        }//add k333123
        public ExineColor ExColor
        {
            get { return Info.ExColor; }
        }//add k333123

        public int ExPortraitLen
        {
            get { return Info.ExPortraitLen; }
        }//add k333123
        public byte[] ExPortraitBytes
        {
        ...
        protected virtual void Load(CharacterInfo info, ExineConnection connection) { }
        ...
        public override void Process()
        {
            ...
            if (Stacking && Envir.Time > StackingTime)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    if (Pushed(this, (ExineDirection)i, 1) == 1) break;
                }
            }
        ...
        public bool Walk(ExineDirection dir)
        {
            if (!CanMove || !CanWalk)
            {
        ...
        public bool Run(ExineDirection dir)
        {
        ...
        public void RangeAttack(ExineDirection dir, Point location, uint targetID)
        {
        ...
        public void Attack(ExineDirection dir, Spell spell)
        {
            LogTime = Envir.Time + Globals.LogDelay;
        ...
        public virtual void BeginMagic(Spell spell, ExineDirection dir, uint targetID, Point location, Boolean spellTargetLock = false)
        {
                ...
                for (int y = CurrentLocation.Y - d; y <= CurrentLocation.Y + d; y++)
                {
                    ...
                    for (int x = CurrentLocation.X - d; x <= CurrentLocation.X + d; x += Math.Abs(y - CurrentLocation.Y) == d ? 1 : d * 2)
                    {
                        ...
                        for (int i = 0; cell.Objects != null && i < cell.Objects.Count; i++)
                        {
                            ...
                            ExineDirection dir = Functions.DirectionFromPoint(CurrentLocation, ob.CurrentLocation);
        ...
        private void CounterAttackCast(UserMagic magic, MapObject target)
        {
            ...
            ExineDirection dir = Functions.ReverseDirection(target.Direction);
            Direction = dir;
        ...
        public void DoKnockback(MapObject target, UserMagic magic)//ElementalShot - knockback
        {
            ...
            int distance = 1 + Math.Max(0, magic.Level - 1) + Envir.Random.Next(2);
            ExineDirection dir = Functions.DirectionFromPoint(CurrentLocation, target.CurrentLocation);
        ...
        protected void CompleteMagic(IList<object> data)
        {
            ...
            switch (magic.Spell)
            {
                ...
                case Spell.Entrapment:
                    ...
                    ExineDirection pulldirection = (ExineDirection)((byte)(Direction - 4) % 8);
                    int pulldistance = 0;
                    if ((byte)pulldirection % 2 > 0)
                        ...
                        pulldistance = pulldirection == ExineDirection.Up || pulldirection == ExineDirection.Down ? Math.Abs(CurrentLocation.Y - target.CurrentLocation.Y) - 2 : Math.Abs(CurrentLocation.X - target.CurrentLocation.X) - 2;
