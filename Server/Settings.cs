...
namespace Server
{
    public static class Settings
    {
        ...
        //General
        public static string VersionPath = Path.Combine(".", "Exine.Exe");
        public static bool CheckVersion = true;
        public static List<byte[]> VersionHashes;
        public static string GMPassword = "Exine$1";
        ...
        public static BaseStats[] ClassBaseStats = new BaseStats[5] { new BaseStats(ExineClass.Warrior), new BaseStats(ExineClass.Wizard), new BaseStats(ExineClass.Taoist), new BaseStats(ExineClass.Assassin), new BaseStats(ExineClass.Archer) };
        ...
        public static void LoadEXP()
        {
            ...
            //for (int i = 1; i <= 500; i++)
            for (int i = 1; i <= 100; i++) //k333123 mod 241008
            {
        ...
        {
            Array.Resize(ref Hero_CanCreateClass, Enum.GetNames(typeof(ExineClass)).Length);
            ...
            for (int i = 0; i < Hero_CanCreateClass.Length; i++)
                Hero_CanCreateClass[i] = reader.ReadBoolean("Hero", $"CanCreate{Enum.GetName(typeof(ExineClass), i)}", true);
        ...
        public static void SaveHeroSettings()
        {
            ...
            for (int i = 0; i < Hero_CanCreateClass.Length; i++)
                reader.Write("Hero", $"CanCreate{Enum.GetName(typeof(ExineClass), i)}", Hero_CanCreateClass[i]);
