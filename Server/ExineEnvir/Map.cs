        ...
        private void CompleteMagic(IList<object> data)
        {
            ...
            switch (magic.Spell)
            {
                ...
                case Spell.IceThrust:
                    {
                        location = (Point)data[2];
                        ExineDirection direction = (ExineDirection)data[3];
                ...
                case Spell.TrapHexagon:
                    ...
                    {
                        Point startpoint = Functions.PointMove(location, (ExineDirection)i, 2);
                        for (byte j = 0; j <= 4; j += 4)
                        {
                            ExineDirection spawndirection = i == 0 || i == 4 ? ExineDirection.Right : ExineDirection.Up;
