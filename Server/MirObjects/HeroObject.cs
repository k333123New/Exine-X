...
namespace Server.ExineObjects
{
    public class HeroObject : HumanObject
    {
        ...
        public override ExineConnection Connection
        {
        ...
        protected ExineDirection NextMagicDirection;
        ...
        public override void BeginMagic(Spell spell, ExineDirection dir, uint targetID, Point location, bool spellTargetLock = false)
        {
