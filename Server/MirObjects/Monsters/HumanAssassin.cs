...
namespace Server.ExineObjects.Monsters
{
    public class HumanAssassin : MonsterObject
    {
        ...
        private void ExplosionDie()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ExineDirection dir = (ExineDirection)(i % 8);
        ...
        public override Packet GetInfo()
        {
            ...
            return new S.ObjectPlayer
            {
                ...
                Class = master != null ? master.Class : ExineClass.Assassin,
                Gender = master != null ? master.Gender : ExineGender.Male,
                ExStyle = master != null ? master.ExStyle : ExineStyle.Style0, //add k333123
